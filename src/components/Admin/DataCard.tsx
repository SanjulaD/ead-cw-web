      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-5 2xl:gap-7.5">
        {[
          ...
          },
          {
            ...
            color: '#FF9C55',
            title: 'Total # of Study Sessions',
            value: `${totalNumberOfStudySessions}`,
          },
          {
            icon: (
              <svg
          ...
          },
          {
            ...
            value: `${(totalStudyTimeLogged / 60).toFixed(2)} Hrs`,
          },
          {
            icon: (
              <svg
            ...
            color: '#18BFFF',
            title: 'Total Break Time',
            value: `${(totalBreakTimeLogged / 60).toFixed(2)} Hrs`,
          },
        ].map((item, index) => (
          <div
            key={index}
