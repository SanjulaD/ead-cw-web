...
import { type dataStats } from '@/types/dashboard';
...
const dataStatsList = [
  ...
  },
  {
    ...
    color: '#FF9C55',
    title: 'Total Number of Study Sessions',
    value: '$42.2K',
  },
  {
    icon: (
    ...
    color: '#8155FF',
    title: 'Total Number of Breaks Taken',
    value: '2.450',
  },
  {
    icon: (
  ...
  },
  {
    ...
    color: '#18BFFF',
    title: 'Total Break Time Logged',
    value: '3.465',
  },
];

const DataCard: React.FC<dataStats> = () => {
  return (
