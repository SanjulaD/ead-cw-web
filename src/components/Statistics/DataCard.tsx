        ...
        {[
          {
            ...
            value: `${(totalStudyTimeMinutes / 60).toFixed(2)} Hrs`,
          },
          {
            icon: (
              <svg
            ...
            color: '#FF9C55',
            title: 'Average Study Sessions',
            value: `${averageStudySessionDuration.toFixed(1)} Mins`,
          },
          {
            icon: (
              <svg
            ...
            value: `${(totalBreakTimeMinutes / 60).toFixed(1)} Hrs`,
          },
          {
            icon: (
              <svg
            ...
            value: `${numberOfStudySessions}`,
          },
        ].map((item, index) => (
          <div
            key={index}
            className="relative rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark"
          >
